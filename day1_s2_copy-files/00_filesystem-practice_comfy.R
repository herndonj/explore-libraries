...
path_to_other_object <- "~/Desktop/day1_s1_explore-libraries/"
basename(path_to_other_object) # just testing
dir_exists(path_to_other_object) #does the directory exist?
#let's use fs
dir_copy(path_to_other_object,here())
